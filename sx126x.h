...
public:
  ...
  void setPins(int ss = LORA_DEFAULT_SS_PIN, int reset = LORA_DEFAULT_RESET_PIN, int dio0 = LORA_DEFAULT_DIO0_PIN, int busy = LORA_DEFAULT_BUSY_PIN,  int txen = LORA_DEFAULT_TXEN_PIN, int rxen = LORA_DEFAULT_RXEN_PIN);
